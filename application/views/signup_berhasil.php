...
<body class="hold-transition sidebar-mini layout-fixed sidebar-closed sidebar-collapse">
    <div class="wrapper">
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left: -0.4rem!important;">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
            ...
            <div class="navbar-nav mr-auto ml-auto">
                <img src="<?= base_url('assets') ?>/dist/img/fullbanner.png" alt="" class="brand-image" style="height: 50px">
            </div>
        </nav>
        <!-- /.navbar -->
