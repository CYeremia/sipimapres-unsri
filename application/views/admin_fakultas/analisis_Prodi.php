...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Analisis Peringkat Prodi</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Peringkat Prodi Berdasarkan Prestasi</h3>
            </div>
            <!-- /.card-header -->
            <div class=" card-body">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Peringkat Prodi Berdasarkan Mahasiswa Berprestasi</h3>
            </div>
            <!-- /.card-header -->
            <div class=" card-body">
                <div class="table-responsive">
